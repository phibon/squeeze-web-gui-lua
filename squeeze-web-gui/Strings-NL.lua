...
return {
	...
	['network'] = {
		...
		"<li><i><b>Bij Opstart</b></i> bepaalt of de interface wordt geactiveerd wanneer het apparaat wordt gestart. Zorg ervoor dat deze instelling bij ten minste ��n interface gezet is.</li>" ..
